...
import { StyleSheet, SafeAreaView,Image, Text, View, TextInput, ScrollView, TouchableOpacity, FlatList } from "react-native";
import MaterialCommunityIcons from "react-native-vector-icons/MaterialCommunityIcons";
import datas from "../model/data";

const ProductsScreen = ({navigation}) => {

  const categories=['Margarita','Piknik','Parti','Pepperoni Pizza','Sebze','Sucukbol','Akdeniz','Karışık']
    ...
    <SafeAreaView style={styles.mainContainer}>
      <View style={styles.subContainer}>
        <View style={styles.headerContainer}>
         ...
         <View>
          <Text>Hoşgeldin!</Text>
          <Text style={styles.headerText}>Merve</Text>
         </View>
        </View>
        </View>
        ...
        <View style={styles.inputContainer}>
          <View style={{flexDirection:'row'}}>
            <MaterialCommunityIcons style={{marginRight:20}} name="magnify" color="gray" size={26}/>
